					    		...
					    		<fieldset>
							    	...
							    	<div class="row">
								    	...
								    	<div class="col-sm-4">
									  		@if($can_update)
											  	<div class="handle horizontal text-center">
													<a href="javascript:void(0)" data-link="{{ route('admin.setting.system.notification.toggle', 'enable_chat') }}" type="button" class="btn btn-md btn-secondary btn-toggle {{ $system->enable_chat ? 'active' : '' }}" data-toggle="button" aria-pressed="{{ $system->enable_chat ? 'true' : 'false' }}" autocomplete="off">
														<div class="btn-handle"></div>
													</a>
											  	</div>
											@else
